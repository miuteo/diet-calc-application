...
class FoodNutritionalValueResourceIT {
    ...
    void getAllFoodNutritionalValues() throws Exception {
        ...
        restFoodNutritionalValueMockMvc
            ...
            .andExpect(jsonPath("$.[*].fatCal").value(hasItem(DEFAULT_FAT_CAL)))
            .andExpect(jsonPath("$.[*].carbohydrate").value(hasItem(DEFAULT_CARBOHYDRATE)))
            .andExpect(jsonPath("$.[*].carbohydrateCal").value(hasItem(DEFAULT_CARBOHYDRATE_CAL)))
    ...
    void getFoodNutritionalValue() throws Exception {
        ...
        restFoodNutritionalValueMockMvc
            ...
            .andExpect(jsonPath("$.fatCal").value(DEFAULT_FAT_CAL))
            .andExpect(jsonPath("$.carbohydrate").value(DEFAULT_CARBOHYDRATE))
            .andExpect(jsonPath("$.carbohydrateCal").value(DEFAULT_CARBOHYDRATE_CAL))
